...
! Updated Jan 2007 to handle better ice saturation  below -85C
!
...
real esat,esatw_crm
esat = esatw_crm(t)
qsatw_crm = 0.622 * esat/max(esat,p-esat)
end
...
if(t.gt.185.) then
  ...
  dt = max(-100.,t-273.16)
  esati_crm = 0.00763685 + dt*(0.000151069+dt*7.48215e-07)
end if
end
...
real esat,esati_crm
esat=esati_crm(t)
qsati_crm=0.622 * esat/max(esat,p-esat)
end
...
if(t.gt.185.) then
  ...
  dt = max(-100.,t-273.16)
  dtesati_crm = 0.0013186 + dt*(2.60269e-05+dt*1.28676e-07)
end if
end
